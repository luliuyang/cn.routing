...
public class Car {
    ...
    /**
     * 出发地，对于car.txt中的from,读取初始化
     */
    private String fromCrossID;
    /**
     * 目的地，对应car.txt中的to，读取初始化
     */
    private String toCrossID;
    /**
     * 当前出发路口，初始化时就是fromCrossID
     */
    private String curFromCrossID;
    /**
     * 当前目的路口，初始化：null
     */
    private String curToCrossID;
    /**
     * 车辆自身的最大行驶速度，对应car.txt中的speed,读取初始化
     */
     ...
     * 等待状态是否安排过，初始化：false
     */
    private boolean hasArrangedOrNot;
    /**
     * 设置状态位,初始状态设为-1
     */
    private int state;
